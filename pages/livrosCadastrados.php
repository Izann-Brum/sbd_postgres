...
<?php foreach ($Livros as $Livro) : ?>
    <tr>
        ...
        <td><center><input type="text" name="Titulo" class="input-group-text" value="<?php echo htmlspecialchars($Livro['Titulo'])?>"></center></td>
        <td><center><input type="text" name="Nome_autor" class="input-group-text" value="<?php echo htmlspecialchars($Livro['Nome_autor'])?>" readonly></center></td>
        <td><center><input type="text" name="Nome_editora" value="<?php echo htmlspecialchars($Livro['Nome_editora'])?>" class="input-group-text" readonly></center></td>
