...
<?php foreach ($Editoras as $Editora) : ?>
    <tr>
        ...
        <td><center><input type="text" class="input-group-text" name="Cod_editora" value="<?php echo $Editora['Cod_editora']?>" readonly></center></td>
        <td><center><input type="text" name="Nome" class="input-group-text" value="<?php echo htmlspecialchars($Editora['Nome'])?>"></center></td>
        <td><center><input type="text" name="Endereco" value="<?php echo htmlspecialchars($Editora['Endereco'])?>" class="input-group-text"></center></td>
        <td><center><input type="text" name="Telefone" value="<?php echo htmlspecialchars($Editora['Telefone'])?>" class="input-group-text"></center></td>
