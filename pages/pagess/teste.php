...
<link rel="stylesheet" href="teste.css" media="screen">
  ...
  <body class="u-body u-overlap u-overlap-transparent u-xl-mode">
    <section class="u-align-center u-clearfix u-image u-section-1" id="sec-4cf6" data-image-width="6000" data-image-height="4000">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-custom-color-3 u-opacity u-opacity-95 u-radius-9 u-shape u-shape-round u-shape-1"></div>
        ...
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            ...
            <div class="u-form-group u-form-name">
              ...
              <input type="text" placeholder="Nome" id="name-9b6e" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            ...
            <div class="u-form-group u-form-group-3">
              ...
              <input type="text" placeholder="Telefone" id="text-9737" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
