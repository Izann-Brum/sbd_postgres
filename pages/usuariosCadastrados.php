...
<?php foreach ($Usuarios as $Usuario) : ?>
    <tr>
        ...
        <td><center><input type="text" name="Num_cartao" class="input-group-text" value="<?php echo htmlspecialchars($Usuario['Num_cartao'])?>" readonly></center></td>
        <td><center><input type="text" name="Nome" class="input-group-text" value="<?php echo htmlspecialchars($Usuario['Nome'])?>"></center></td>
        <td><center><input type="text" name="Endereco" value="<?php echo htmlspecialchars($Usuario['Endereco'])?>" class="input-group-text"></center></td>
        <td><center><input type="text" name="Telefone" value="<?php echo htmlspecialchars($Usuario['Telefone'])?>" class="input-group-text"></center></td>
